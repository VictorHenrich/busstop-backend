...
from utils.responses import BaseJSONResponse, SuccessJSONResponse
...
async def list_companies(
...
) -> BaseJSONResponse[List[CompanyEntity]]:
    ...
    return SuccessJSONResponse(companies_handled)


@ServerInstances.api.get("/company/{company_uuid}")
async def get_company(company_uuid: str) -> BaseJSONResponse[Optional[CompanyEntity]]:
    ...
    return SuccessJSONResponse(company_handled)


@ServerInstances.api.post("/company")
async def create_company(company_body: CompanyBodyEntity) -> BaseJSONResponse[None]:
...
async def delete_company(company_uuid: str) -> BaseJSONResponse[None]:
