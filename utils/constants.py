...
AGENT_PUBLIC_ROUTES: Sequence[str] = (DOCS_ENDPOINT_NAME, REDOC_ENDPOINT_NAME)

USER_PRIVATE_ROUTES: Sequence[str] = (GEO_ENPOINT_NAME,)
...
SWAGGER_AGENT_SESSION_TAG: str = os.environ.get("SWAGGER_AGENT_SESSION_TAG", "")
SWAGGER_USER_SESSION_TAG: str = os.environ.get("SWAGGER_USER_SESSION_TAG", "")
